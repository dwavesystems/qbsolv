# -*- coding: utf-8 -*-
#
# qbsolv documentation build configuration file
#
...
# built documents.
#
#from qbsolv.package_info import __version__
...
latex_documents = [
    (master_doc, 'qbsolv.tex', u'qbsolv Documentation',
...
man_pages = [
    (master_doc, 'qbsolv', u'qbsolv Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'qbsolv', u'qbsolv Documentation',
     author, 'qbsolve', 'One line description of project.',
     'Miscellaneous'),
]
